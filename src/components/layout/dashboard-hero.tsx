export function DashboardHero({
  ...
  return (
    <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-primary via-primary to-[oklch(0.22_0.08_275)] px-8 py-10 shadow-lg shadow-primary/10">
